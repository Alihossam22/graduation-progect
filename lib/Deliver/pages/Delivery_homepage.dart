...
class delivery_homepage extends StatefulWidget {
  const delivery_homepage({Key? key}) : super(key: key);

  @override
  _delivery_homepageState createState() => _delivery_homepageState();
}
      ...
      body: ListView(
        children: [
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(
                  context, MaterialPageRoute(builder: (context)=> delivery_orderdetails())
              );
            },
            child: Padding(
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    const Expanded(
                        flex: 1,
                        child: Image(image: AssetImage('images/watch.png',),height: 150,),
