...
import 'package:test1graduation/seller/pages/OrderDetails.dart';
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      const Expanded(
                          flex: 1,
                          child: Image(image: AssetImage('images/watch.png',),height: 130,),
                      ),
                      Expanded(
                          flex: 2,
                          child: Column(
                            children: [
                              ...
                              const Padding(
                                ...
                                child: Text("casio",style: TextStyle(color: Colors.white , fontSize: 20 ,fontWeight: FontWeight.bold),),
                              ),
                              const SizedBox(
                                height: 10,
                              ),
